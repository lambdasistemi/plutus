...
byte-identical to the 64-bit chain. *Try it live:* https://lambdasistemi.github.io/plutus/ — evaluate
UPLC in your browser. For what changed, how to pin it as a dependency, and the prebuilt `uplc.wasm`
evaluator, see link:WASM32.md[WASM32.md].
====
